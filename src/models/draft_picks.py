...
class Draft_Picks(object):
    def __init__(self, room_id, username, pool_pick_num, user_pick_num, car_num=None, drv_full=None, position=None ,_id=None):
    ...
    def update_pick(cls, room_id, username, pick_num, car_num, drv_full):
        ...
        data = Database.find_one("picks", {
            "$and": [{"room_id": room_id}, {"username.username": username}, {"pool_pick_num" : int(pick_num)}]})
