...
def add_headers(response):
    response.headers.add('Access-Control-Allow-Origin', 'www.behoughton.com, http://www.behoughton.com/, http://www.behoughton.com/login/, http://www.behoughton.com/nascar/')
