...
def add_headers(response):
    ...
    response.headers.add('Access-Control-Allow-Headers', 'Content-Type,Authorization, X-Request-Id, X-Forwarded-For, X-Forwarded-Proto, X-Forwarded-Port, X-Request-Start')
