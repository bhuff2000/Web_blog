...
def add_headers(response):
    response.headers.add('Access-Control-Allow-Origin', 'http://www.behoughton.com/*, www.behoughton.com, http://www.behoughton.com/, http://www.behoughton.com/login/, http://www.behoughton.com/nascar/')
    ...
    MYLOG.debug("request headers " + str(request.headers))
    MYLOG.debug("response headers " + str(response.headers))
...
def nascar_pool_results(room_id):
    ...
    for sorted_pick in sorted_pool_picks:
        if sorted_pick["user_pick_num"] == round_num:
            ...
            print("round pick rev 437 " + str(round_picks))
        else:
            if round_num % 2 == 0:
                #rev_round_picks = round_picks.reverse()
            ...
            print("round pick 450 " + str(round_picks))
    #round_num = round_num-1
